		...
		<view class="imt-audio">
			...
			<view class="audio-control-wrapper" :style="{color}">
				...
				<view v-show="!paused" :style="{borderColor:color}" @click="pause">
					<image src="/static/music/play_sed.png" class="audio-control-switch audio-icon1"></image>
				</view>
				<view v-show="paused" :style="{borderColor:color}" @click="play">
					<image src="/static/music/play.png" class="audio-control-switch audio-icon1"></image>
				</view>
