<template>
	<view ref="node"
		...
		<view class="ly-tree-node__content" 
			...
			<view v-if="node.data.gender==1&&node.data.parent_relationship!='partner'">
				<text>【</text>
				<text @tap.stop="handleExtButtonClick('newchildren')" class="ly-tree-node__extbutton">新增子女</text>
				<text>】</text>
			</view>
			<view v-if="node.data.parent_relationship!='partner'">
				<text>【</text>
				<text @tap.stop="handleExtButtonClick('newpartner')" class="ly-tree-node__extbutton" >新增配偶</text>
				<text>】</text>
			</view>
			<view>
				<text>【</text>
